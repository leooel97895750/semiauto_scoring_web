...
event_path = r"G:/共用雲端硬碟/Sleep center data/auto_detection/respiratory_detect/workshop0606data/result/"
# 讀取預測與偵測結果的檔案
# stage
...
for i in range(len(apnea)):
    if apnea[i] == 1 and start == 0:
        ...
        start = 0
        # 將此段事件插入資料庫
        sql = "insert into event_prediction (psg_file_id, type, timefrom, timeto, eventid, channelid)"
